    ...
    <div class="container justify-content-center bloc-3">
      <div class="row text-center">
        <p class="col-12 col-sm-12 col-md-8 col-lg-10 text-vision offset-lg-1 mt-2 pt-lg-3 text_histoire_1">
            ...
            GRANDS LACS et le PLATEAUX OUBANGUIEN.  C’est de ces deux régions d’où proviennent la plupart des populations de la République du Congo.
        </p>
      </div>
    </div>
    <div class="container justify-content-center bloc-4 mt-3 text_histoire_1">
      <div class="row text-center">
        <p class="col-12 col-sm-12 col-md-8 col-lg-8 text-vision offset-lg-1 mt-2 pt-lg-5">
            ...
            bantous installés en République du Congo et
            principalement dans la cuvette ouest, dans le district d’Ewo à une quarantaine de mètre de la
            frontière du GABON.
        </p>
        <div class="col-12 col-sm-12 col-md-4 col-lg-2 mt-3 mb-2">
          <a href="images/bakanigui_05.png"><img class="image col-8" src="images/bakanigui_05 (2).png" alt="image"></a>
        </div>
      </div>
    </div>
    ...
    <div class="container justify-content-center bloc-5 mt-3">
      <div class="row text-center">
        ...
        <p class="col-12 col-sm-12 col-md-8 col-lg-8 text-vision mt-2 pt-lg-3">
          Les MBOCHIS, vinrent s'installer dans la région d’Ewo et entreprit des guerres contre tous les peuples de la région. Les Bakanigui décidèrent donc de quitter la région d’Ewo.
          Ils remontèrent par la Sébé (Affluent) de l’ogooué et s’installèrent au GABON dans un premier temps dans la zone d’Okondja.  
          Ensuite, les Obamba repoussés par les MBOCHIS vinrent s’installer également dans la zone
          d’Okondja. Leur premier village était Andjokou, sur une montagne à côté d’Okondja. Ils trouvèrent
          sur la Sébé le chef Oshashi, qui commandait aux Akanigui, venus les premiers avec les Pygmées
          (Akoula ou Abongo). 
          Ils luttèrent contre les Bakanigui et les Pygmées et les repoussèrent sur
          l’Ogooué. Les Bakanigui vinrent alors s’installer dans la région de la basse Passa où on les
